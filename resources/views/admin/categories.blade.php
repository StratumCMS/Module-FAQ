    ...
    @push('scripts')
        <script>
            function openEditModal(button) {
                ...
                form.action = '{{ route("admin.faq.categories.update", ":id") }}'.replace(':id', button.dataset.id);
                ...
                document.getElementById('edit_is_public').checked = button.dataset.is_public === "true" || button.dataset.is_public === "1";
